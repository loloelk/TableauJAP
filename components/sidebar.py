...
ROLE_PERMISSIONS = {
    "admin": [ "Vue d'Ensemble", "Tableau de Bord du Patient", "Parcours Patient", "Analyse des Interventions Pharmacologiques",
               "Plan de Soins et Entrées Infirmières", "Suivi des Effets Secondaires"],
    "md": [ "Vue d'Ensemble", "Tableau de Bord du Patient", "Parcours Patient", "Analyse des Interventions Pharmacologiques",
...
def render_sidebar():
    ...
    with st.sidebar:
        st.title("🧠 Tableau de Bord Premier Épisode Psychotique")
        ...
        all_main_options = {
            ...
            "Analyse des Interventions Pharmacologiques": "Comparaison de l'efficacité des traitements antipsychotiques.",
